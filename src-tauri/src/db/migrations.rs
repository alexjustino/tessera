...
const MIGRATIONS: &[(&str, &str)] = &[
    ...
    (
        "011_time_entries",
        include_str!("../../migrations/011_time_entries.sql"),
    ),
    (
        "012_templates",
        include_str!("../../migrations/012_templates.sql"),
    ),
    (
        "013_imports",
        include_str!("../../migrations/013_imports.sql"),
    ),
    (
        "014_import_before",
    ...
    ("016_goals", include_str!("../../migrations/016_goals.sql")),
];
